...
var qe = (c, e, i) =>
    e in c
      ? pi(c, e, { enumerable: !0, configurable: !0, writable: !0, value: i })
      : (c[e] = i),
  Q = (c, e) => {
...
const ge = (c, e) => {
  ...
  Xe = (c) => {
    ...
    return (
      c && c.length > 0 && e.appendChild(document.createTextNode(c)),
  ...
  Ei = (c, e = 0) => {
    ...
    if (c) {
      ...
      return (
        ...
        (t =
          e - (((i = c.parentElement) == null ? void 0 : i.offsetHeight) || 0)),
        (c.style.height = s + "px"),
  ...
  le =
    /(iphone|ipod|ipad|android)/gi.test(Vt) ||
...
var ki = (function (c) {
  if (c) {
    var e = function (f) {
      ...
      B = function (f) {
        f.observeMutations &&
          ((f.observer = new MutationObserver(U(f, t))),
      ...
      q = {
        ...
        maxSize: 512,
        multiLine: !0,
        observeMutations: "MutationObserver" in c && {
          subtree: !0,
          childList: !0,
          characterData: !0,
        },
    ...
    var T = Object.assign({}, q, S),
      X = f.map(function (K) {
        ...
        return (
          (function (D) {
            ((D.originalStyle = {
              whiteSpace: D.element.style.whiteSpace,
              display: D.element.style.display,
              fontSize: D.element.style.fontSize,
            }),
              B(D),
              (D.newbie = !0),
              (D.dirty = !0),
  ...
  function C(f) {
    ...
    return typeof f == "string"
      ? F(e(document.querySelectorAll(f)), S)
      : F([f], S)[0];
  }
      ...
      (E(e, 'img[src$=".gif"]').forEach((t) => {
        ...
        E(e, "video, audio").forEach((t) => {
          ...
          if (
            (typeof s != "boolean" &&
              (s =
                t.hasAttribute("data-autoplay") || !!V(t, ".slide-background")),
            ...
            t.readyState > 1
              ...
              : le
                ? (t.addEventListener("canplay", this.ensureMobileMediaPlaying),
  ...
  startEmbeddedIframe(e) {
    ...
    if ((this.preventIframeAutoFocus(e), i && i.contentWindow)) {
      ...
      if (t && s) {
        ...
        (typeof a != "boolean" &&
          (a = i.hasAttribute("data-autoplay") || !!V(i, ".slide-background")),
      ...
      e &&
        ...
        (E(e, "video, audio").forEach((t) => {
          !t.hasAttribute("data-ignore") &&
            ...
            t.pause(),
            le &&
              t.removeEventListener("canplay", this.ensureMobileMediaPlaying));
        }),
...
const Ge = (c) => {
  ...
  Ni = (c) => (
    ...
    c ? (c.r * 299 + c.g * 587 + c.b * 114) / 1e3 : null
  );
class Bi {
  constructor(e) {
    this.Reveal = e;
  ...
  update(e = !1) {
    ...
    (t &&
      this.bubbleSlideContrastClassToElement(t, this.Reveal.getRevealElement()),
      setTimeout(() => {
...
class Hi {
  ...
  run(e, i) {
    ...
    if (
      ...
      let h = this.getAutoAnimatableElements(e, i).map((u) =>
        this.autoAnimateElements(u.from, u.to, u.options || {}, r, Nt++),
      );
      if (
        ...
        (this.getUnmatchedAutoAnimateElements(i).forEach((y) => {
          ...
          ((p.duration !== r.duration || p.delay !== r.delay) &&
            ((b = "unmatched-" + Nt++),
            h.push(
              `[data-auto-animate="running"] [data-auto-animate-target="${b}"] { transition: opacity ${p.duration}s ease ${p.delay}s; }`,
            )),
  ...
  autoAnimateElements(e, i, t, s, a) {
    ...
    if (
      (i.classList.contains("fragment") && delete h.styles.opacity,
    ...
    for (let y in h.styles) {
      ...
      p === b
        ? delete h.styles[y]
        : (p.explicitValue === !0 && (h.styles[y] = p.value),
          b.explicitValue === !0 && (o.styles[y] = b.value));
    }
    let u = "",
        ...
        xe(o.from, a)
          ...
          : xe(o.from, "pre") &&
            ...
            this.findAutoAnimateMatches(
              ...
              (h) => h.getAttribute("data-line-number"),
              {
                scale: !1,
                styles: ["width"],
                measure: this.getLocalBoundingBox.bind(this),
    ...
    const u = (g, y, p, b) => {
      ...
      if (h && this.Reveal.shouldAutoAnimateBetween(h, g))
        ...
        if (((A.className = "scroll-page"), r.push(A), b && t.length > y)) {
          ...
          U && U.background
            ? (A.style.background = U.background)
  ...
  syncPages() {
    ...
    ((this.pages = h.map((u) => {
      ...
      ((y += g.autoAnimatePages.reduce(
        (p, b) => p + Math.max(b.scrollTriggers.length - 1, 0),
            ...
            ((o.progressBarSlide = document.createElement("div")),
              ...
              (o.scrollTriggerElements = o.scrollTriggers.map((h, u) => {
                ...
                return (
                  ...
                  (g.style.top =
                    (h.range[0] - r.range[0]) * this.progressBarHeight + "px"),
                  (g.style.height =
                    (h.range[1] - h.range[0]) * this.progressBarHeight -
                    a +
                    "px"),
  ...
  syncScrollPosition() {
    ...
    (this.slideTriggers.forEach((h) => {
      ...
      (a >= h.range[0] - i * 2 && a <= h.range[1] + i * 2 && !u.loaded
        ...
        a >= h.range[0] && a <= h.range[1]
          ? (this.activateTrigger(h), (o = h.page))
          : h.active && this.deactivateTrigger(h));
    }),
      o &&
        o.scrollTriggers.forEach((h) => {
          r >= h.range[0] && r <= h.range[1]
            ? this.activateTrigger(h)
            : h.active && this.deactivateTrigger(h);
        }),
...
class Ui {
  ...
  activate() {
    return It(this, null, function* () {
      ...
      (yield new Promise(requestAnimationFrame),
        this.Reveal.layoutSlideContents(o, h),
        yield new Promise(requestAnimationFrame));
      ...
      (i.forEach(function (A, M) {
        if (A.classList.contains("stack") === !1) {
          ...
          ((z = Math.min(z, e.pdfMaxPagesPerSlide)),
            ((z === 1 && e.center) || A.classList.contains("center")) &&
              (U = Math.max((r - re) / 2, 0)));
          ...
          if (e.pdfSeparateFragments) {
            const B = this.Reveal.fragments.sort(
  ...
  getIndicesFromHash(e = window.location.hash, i = {}) {
    ...
    if (!/^[0-9]*$/.test(s[0]) && t.length) {
      ...
      let r = a.hashOneBasedIndex || i.oneBasedIndex ? 1 : 0,
        ...
        u;
      return (
        a.fragmentInURL && ((u = parseInt(s[2], 10)), isNaN(u) && (u = void 0)),
        { h: o, v: h, f: u }
      );
    }
    return null;
...
function Ut(c, e) {
  arguments.length < 2 &&
    ((e = arguments[0]), (c = document.querySelector(".reveal")));
  const i = {};
  let t = {},
    s = !1,
    a = !1,
  ...
  function Wt(n) {
    ...
    if (
      ((s = !0),
      (l.wrapper = c),
      (l.slides = c.querySelector(".slides")),
      !l.slides)
    )
    ...
    (n || d) &&
      ...
      n
        ? document.readyState === "complete"
          ? F.activate()
          : window.addEventListener("load", () => F.activate())
        : k.activate());
  }
  function Je() {
    t.showHiddenSlides ||
  ...
  function Gt() {
    (document.addEventListener("fullscreenchange", Pe),
      document.addEventListener("webkitfullscreenchange", Pe));
  }
  function Jt() {
  ...
  function Ze(n) {
    ...
    (l.wrapper.classList.remove(d.transition),
      ...
      v > 1 &&
        ...
        ((O = new es(l.wrapper, () =>
          Math.min(Math.max((Date.now() - re) / M, 0), 1),
        )),
        O.on("click", fi),
        (z = !1)),
  ...
  function Ne(n) {
    (typeof n.layout == "string" && (b.layout = n.layout),
      ...
      b.layout
        ? ae(l.slides, b.layout + " " + b.overview)
        : ae(l.slides, b.overview));
  }
          ...
          N.style.display !== "none" &&
            (t.center || N.classList.contains("center")
              ? N.classList.contains("stack")
                ? (N.style.top = 0)
                : (N.style.top =
                    Math.max((v.height - N.scrollHeight) / 2, 0) + "px")
              : (N.style.top = ""));
        }
        m !== p &&
          j({
  ...
  function we(n, d) {
    ...
    return (
      ...
      typeof w.width == "string" &&
        /%$/.test(w.width) &&
        (w.width = (parseInt(w.width, 10) / 100) * w.presentationWidth),
      typeof w.height == "string" &&
        /%$/.test(w.height) &&
        (w.height = (parseInt(w.height, 10) / 100) * w.presentationHeight),
      w
    );
  }
  function nt(n, d) {
  ...
  function Be() {
    return u
      ? !(u.nextElementSibling || (pe(u) && u.parentNode.nextElementSibling))
      : !1;
  }
  function ct() {
    if (t.pause) {
  ...
  function Y(n, d, v, m) {
    ...
    (d === void 0 && !f.isActive() && (d = ot(P[n])),
      h &&
        h.parentNode &&
        h.parentNode.classList.contains("stack") &&
        nt(h.parentNode, o));
    const x = y.concat();
    y.length = 0;
    let N = r || 0,
    ...
    (G &&
      ...
      ((A = "running"),
      (ee = He(h, u, N, oe)),
      ee && l.slides.classList.add("disable-slide-transitions")),
      Ve(),
      he(),
      f.isActive() && f.update(),
  ...
  function ai(n, d, v) {
    ...
    ((h = u),
      ...
      w &&
        (R.afterSlideChanged(),
        h &&
          (R.stopEmbeddedContent(h),
          R.stopEmbeddedContent(h.slideBackgroundElement)),
  ...
  function Ve() {
    ...
    if (d && typeof r != "undefined") {
      ...
      (le && (P = w ? 6 : t.mobileViewDistance),
        F.isActive() && (P = Number.MAX_VALUE));
      for (let x = 0; x < d; x++) {
        let N = n[x],
          oe = E(N, "section"),
          G = oe.length;
        if (
          ...
          v < P ? R.load(N) : R.unload(N),
          G)
        ) {
          let $ = w ? 0 : ot(N);
          for (let I = 0; I < G; I++) {
            let ee = oe[I];
            ((m = Math.abs(x === (r || 0) ? (o || 0) - I : I - $)),
  ...
  function Z({ includeFragments: n = !1 } = {}) {
    ...
    if (
      ...
      ((m.left = m.left || w.prev),
        (m.up = m.up || w.prev),
        (m.down = m.down || w.next),
        (m.right = m.right || w.next));
    }
    if (t.rtl) {
      let w = m.left;
  ...
  function pt(n = u) {
    ...
    e: for (let m = 0; m < d.length; m++) {
      ...
      if (w === n) break;
      w.classList.contains("stack") === !1 &&
        w.dataset.visibility !== "uncounted" &&
        v++;
    }
    return v;
  }
    ...
    if (n)
      if (k.isActive())
        ...
        ((d = Math.max(x.indexOf(P), 0)),
          (v = void 0),
          w && (v = Math.max(E(n.parentNode, "section").indexOf(n), 0)));
      }
            ...
            : ((M = t.autoSlide),
              u.querySelectorAll(".fragment").length === 0 &&
                E(u, "video, audio").forEach((w) => {
                  w.hasAttribute("data-autoplay") &&
                    M &&
                    (w.duration * 1e3) / w.playbackRate > M &&
                    (M = (w.duration * 1e3) / w.playbackRate + 1e3);
                })),
        M &&
          !z &&
          !me() &&
  ...
  function ke({ skipFragments: n = !1 } = {}) {
    ...
    t.rtl
      ? (f.isActive() || n || C.next() === !1) &&
        Z().left &&
        Y(r + 1, t.navigationMode === "grid" ? o : void 0)
  ...
  function At({ skipFragments: n = !1 } = {}) {
    ...
    if (n || C.prev() === !1)
      if (Z().up) ze({ skipFragments: n });
        ...
        if (
          (t.rtl
            ? (d = E(l.wrapper, te + ".future").pop())
            : (d = E(l.wrapper, te + ".past").pop()),
