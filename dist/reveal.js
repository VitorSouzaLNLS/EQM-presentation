...
(function (I, b) {
  ...
  var Ge = (I, b, H) =>
      b in I
        ? Ji(I, b, { enumerable: !0, configurable: !0, writable: !0, value: H })
        : (I[b] = H),
    te = (I, b) => {
  ...
  var Wt = (I, b, H) =>
    new Promise((ne, X) => {
      var ve = (ie) => {
        ...
        me = (ie) =>
          ie.done ? ne(ie.value) : Promise.resolve(ie.value).then(ve, V);
  ...
  const I = (h, e) => {
    ...
    ce = (h) => {
      ...
      return (
        h && h.length > 0 && e.appendChild(document.createTextNode(h)),
    ...
    jt = (h, e = 0) => {
      ...
      if (h) {
        ...
        return (
          ...
          (t =
            e -
            (((i = h.parentElement) == null ? void 0 : i.offsetHeight) || 0)),
          (h.style.height = s + "px"),
    ...
    he =
      /(iphone|ipod|ipad|android)/gi.test(et) ||
  ...
  var Xt = (function (h) {
    if (h) {
      var e = function (f) {
        ...
        D = function (f) {
          f.observeMutations &&
            ((f.observer = new MutationObserver(W(f, t))),
        ...
        j = {
          ...
          maxSize: 512,
          multiLine: !0,
          observeMutations: "MutationObserver" in h && {
            subtree: !0,
            childList: !0,
            characterData: !0,
          },
      ...
      var T = Object.assign({}, j, S),
        J = f.map(function ($) {
          ...
          return (
            (function (z) {
              ((z.originalStyle = {
                whiteSpace: z.element.style.whiteSpace,
                display: z.element.style.display,
                fontSize: z.element.style.fontSize,
              }),
                D(z),
                (z.newbie = !0),
                (z.dirty = !0),
    ...
    function C(f) {
      ...
      return typeof f == "string"
        ? O(e(document.querySelectorAll(f)), S)
        : O([f], S)[0];
    }
  ...
  class Yt {
        ...
        b(e, "video, audio").forEach((a) => {
          ...
          (b(a, "source[data-src]").forEach((o) => {
            (o.setAttribute("src", o.getAttribute("data-src")),
              ...
              o.setAttribute("data-lazy-loaded", ""),
              (r += 1));
          }),
    ...
    unload(e) {
      ...
      (i &&
        ...
        b(e, "video[data-lazy-loaded] source[src], audio source[src]").forEach(
          (t) => {
            (t.setAttribute("data-src", t.getAttribute("src")),
              t.removeAttribute("src"));
          },
            ...
            if (
              (typeof s != "boolean" &&
                (s =
                  ...
                  !!V(t, ".slide-background")),
              s && typeof t.play == "function")
            ) {
              if (i && !t.muted) return;
              t.readyState > 1
    ...
    startEmbeddedIframe(e) {
      ...
      if ((this.preventIframeAutoFocus(e), i && i.contentWindow)) {
        ...
        if (t && s) {
          ...
          (typeof a != "boolean" &&
            (a =
              i.hasAttribute("data-autoplay") || !!V(i, ".slide-background")),
        ...
        e &&
          ...
          (b(e, "video, audio").forEach((t) => {
            !t.hasAttribute("data-ignore") &&
              ...
              (t.setAttribute("data-paused-by-reveal", ""),
              t.pause(),
              he &&
                t.removeEventListener(
                  "canplay",
    ...
    resetTemporarilyMutedMedia() {
      new Set([
        ...
        i.hasAttribute("data-muted-by-reveal") &&
          ((i.muted = !1), i.removeAttribute("data-muted-by-reveal"));
      });
    }
    ...
    jump() {
      ...
      return (
        i ||
          ...
          (i = this.Reveal.location.getIndicesFromHash(e, {
            oneBasedIndex: !0,
          }))),
  ...
  const Ve = (h) => {
    ...
    ii = (h) => (
      typeof h == "string" && (h = Ve(h)),
      h ? (h.r * 299 + h.g * 587 + h.b * 114) / 1e3 : null
    );
  class si {
    constructor(e) {
      this.Reveal = e;
    ...
    sync(e) {
      ...
      (e.classList.remove("has-dark-background"),
        ...
        s.backgroundSize &&
          i.setAttribute("data-background-size", s.backgroundSize),
        s.backgroundColor && (i.style.backgroundColor = s.backgroundColor),
        s.backgroundGradient &&
          (i.style.backgroundImage = s.backgroundGradient),
        s.backgroundTransition &&
        ...
        s.backgroundPosition &&
          (t.style.backgroundPosition = s.backgroundPosition),
              ...
              b(u, ".slide-background").forEach((y, p) => {
                ...
                p < w
                  ...
                  : p > w
                    ...
                    : (y.classList.add("present"), g === s.h && (a = y));
              }));
        }),
    ...
    updateParallax() {
      ...
      if (this.Reveal.getConfig().parallaxBackgroundImage) {
        ...
        s.length === 1
          ? (a = r = parseInt(s[0], 10))
          : ((a = parseInt(s[0], 10)), (r = parseInt(s[1], 10)));
  ...
  class ai {
    ...
    run(e, i) {
      ...
      if (
        ...
        e.getAttribute("data-auto-animate-id") ===
          i.getAttribute("data-auto-animate-id") &&
        ...
        ((e.dataset.autoAnimate = "pending"),
          (i.dataset.autoAnimate = "pending"),
          (r.slideDirection = s > a ? "forward" : "backward"));
        let o = e.style.display === "none";
        o && (e.style.display = this.Reveal.getConfig().display);
        let c = this.getAutoAnimatableElements(e, i).map((u) =>
          this.autoAnimateElements(u.from, u.to, u.options || {}, r, st++),
        );
        if (
          (o && (e.style.display = "none"),
          i.dataset.autoAnimateUnmatched !== "false" &&
          ...
          (this.getUnmatchedAutoAnimateElements(i).forEach((y) => {
            ...
            ((p.duration !== r.duration || p.delay !== r.delay) &&
              ((w = "unmatched-" + st++),
              c.push(
                `[data-auto-animate="running"] [data-auto-animate-target="${w}"] { transition: opacity ${p.duration}s ease ${p.delay}s; }`,
              )),
              (y.dataset.autoAnimateTarget = w));
          }, this),
            c.push(
              `[data-auto-animate="running"] [data-auto-animate-target="unmatched"] { transition: opacity ${u}s ease ${g}s; }`,
            ));
        }
    ...
    reset() {
      (b(
        ...
        b(this.Reveal.getRevealElement(), "[data-auto-animate-target]").forEach(
          (e) => {
    ...
    autoAnimateElements(e, i, t, s, a) {
      ...
      if (
        (i.classList.contains("fragment") && delete c.styles.opacity,
        t.translate !== !1 || t.scale !== !1)
      ) {
      ...
      for (let y in c.styles) {
        ...
        p === w
          ? delete c.styles[y]
          : (p.explicitValue === !0 && (c.styles[y] = p.value),
            w.explicitValue === !0 && (o.styles[y] = w.value));
      }
      let u = "",
    ...
    getAutoAnimateOptions(e, i) {
      ...
      return (
        ...
        e.dataset.autoAnimateDuration &&
          (t.duration = parseFloat(e.dataset.autoAnimateDuration)),
        e.dataset.autoAnimateDelay &&
          (t.delay = parseFloat(e.dataset.autoAnimateDelay)),
        t
      );
    }
            ...
            typeof o.from != "undefined" && e === "from"
              ...
              : typeof o.to != "undefined" && e === "to"
                ...
                : (o.property === "line-height" &&
                    (c =
                      parseFloat(r["line-height"]) /
                      parseFloat(r["font-size"])),
                  isNaN(c) && (c = r[o.property])),
    ...
    getAutoAnimatePairs(e, i) {
      ...
      return (
        this.findAutoAnimateMatches(
          ...
          i,
          "[data-id]",
          (o) => o.nodeName + ":::" + o.getAttribute("data-id"),
        ),
        this.findAutoAnimateMatches(
          t,
          e,
          i,
          a,
          (o) => o.nodeName + ":::" + o.textContent.trim(),
        ),
        this.findAutoAnimateMatches(
          t,
          e,
          ...
          (o) =>
            o.nodeName +
            ":::" +
            (o.getAttribute("src") || o.getAttribute("data-src")),
        ),
        this.findAutoAnimateMatches(
          t,
          e,
          ...
          ve(o.from, a)
            ...
            : ve(o.from, "pre") &&
              ...
              this.findAutoAnimateMatches(
                ...
                (c) => c.getAttribute("data-line-number"),
                {
                  scale: !1,
                  styles: ["width"],
                  measure: this.getLocalBoundingBox.bind(this),
      ...
      return [].slice.call(e.children).reduce((i, t) => {
        ...
        return (
          ...
          t.querySelector("[data-auto-animate-target]") &&
            (i = i.concat(this.getUnmatchedAutoAnimateElements(t))),
          i
        );
      }, []);
    }
  ...
  class di {
      ...
      const u = (g, y, p, w) => {
        ...
        if (c && this.Reveal.shouldAutoAnimateBetween(c, g))
          ...
          if (((A.className = "scroll-page"), r.push(A), w && t.length > y)) {
            ...
            W && W.background
              ? (A.style.background = W.background)
        ...
        (l.appendChild(g),
          ...
          g.slideBackgroundElement &&
            (g.slideBackgroundElement.remove("past", "future"),
            l.insertBefore(g.slideBackgroundElement, g)),
          (c = g));
      };
      (i.forEach((g, y) => {
    ...
    createProgressBar() {
      ...
      const e = (s) => {
          let a =
            (s.clientY - this.progressBarInner.getBoundingClientRect().top) /
    ...
    syncPages() {
      ...
      ((this.pages = c.map((u) => {
        ...
        (g.pageElement.style.setProperty(
          "--slide-height",
          e.center === !0 ? "auto" : i.height + "px",
        ),
          ...
          g.autoAnimateElements.length > 0 &&
            this.createAutoAnimateTriggersForPage(g));
        let y = Math.max(g.scrollTriggers.length - 1, 0);
        ((y += g.autoAnimatePages.reduce(
          (p, w) => p + Math.max(w.scrollTriggers.length - 1, 0),
          g.autoAnimatePages.length,
        )),
          g.pageElement
        ...
        return (
          s && g.scrollTriggers.length > 0
            ? ((g.pageHeight = a),
              g.pageElement.style.setProperty("--page-height", a + "px"))
            : ((g.pageHeight = o),
              g.pageElement.style.removeProperty("--page-height")),
          ...
          y > 0
            ? ((g.stickyElement.style.position = "sticky"),
              (g.stickyElement.style.top =
                Math.max((a - g.pageHeight) / 2, 0) + "px"))
            : ((g.stickyElement.style.position = "relative"),
              (g.pageElement.style.scrollSnapAlign =
                g.pageHeight < a ? "center" : "start")),
          g
        );
      })),
    ...
    setTriggerRanges() {
      this.totalScrollTriggerCount = this.slideTriggers.reduce(
        (i, t) => i + Math.max(t.page.scrollTriggers.length, 1),
        0,
      );
      let e = 0;
      (this.slideTriggers.forEach((i, t) => {
        i.range = [
          e,
          e +
            Math.max(i.page.scrollTriggers.length, 1) /
        ...
        s > oi
          ? this.slideTriggers.forEach((r) => {
              ...
              ((o.progressBarSlide = document.createElement("div")),
                ...
                (o.progressBarSlide.style.top =
                  r.range[0] * this.progressBarHeight + "px"),
                (o.progressBarSlide.style.height =
                  (r.range[1] - r.range[0]) * this.progressBarHeight -
                  a +
                  "px"),
                o.progressBarSlide.classList.toggle(
                  "has-triggers",
                  o.scrollTriggers.length > 0,
                ),
                ...
                (o.scrollTriggerElements = o.scrollTriggers.map((c, u) => {
                  ...
                  return (
                    ...
                    (g.style.top =
                      (c.range[0] - r.range[0]) * this.progressBarHeight +
                      "px"),
                    (g.style.height =
                      (c.range[1] - c.range[0]) * this.progressBarHeight -
                      a +
                      "px"),
    ...
    syncScrollPosition() {
      const e = this.viewportElement.offsetHeight,
        ...
        r = Math.max(
          Math.min((t + e / 2) / this.viewportElement.scrollHeight, 1),
          0,
        );
      let o;
      (this.slideTriggers.forEach((c) => {
        ...
        (a >= c.range[0] - i * 2 && a <= c.range[1] + i * 2 && !u.loaded
          ...
          : u.loaded &&
            ((u.loaded = !1), this.Reveal.slideContent.unload(u.slideElement)),
          a >= c.range[0] && a <= c.range[1]
            ? (this.activateTrigger(c), (o = c.page))
            : c.active && this.deactivateTrigger(c));
      }),
        o &&
          o.scrollTriggers.forEach((c) => {
            r >= c.range[0] && r <= c.range[1]
              ? this.activateTrigger(c)
              : c.active && this.deactivateTrigger(c);
          }),
          ...
          .forEach((i) => {
            (i.progressBarSlide.classList.toggle("active", i.active === !0),
              i.scrollTriggers.forEach((t, s) => {
                i.scrollTriggerElements[s].classList.toggle(
                  "active",
                  i.active === !0 && t.active === !0,
                );
              }));
          }),
        this.showProgressBar());
    ...
    getSlideByIndices(e, i) {
      const t = this.getAllPages().find(
        (s) => s.indexh === e && s.indexv === i,
      );
  ...
  class ci {
    ...
    activate() {
      return Wt(this, null, function* () {
        ...
        (yield new Promise(requestAnimationFrame),
          this.Reveal.layoutSlideContents(o, c),
          yield new Promise(requestAnimationFrame));
        ...
        (i.forEach(function (A, N) {
          if (A.classList.contains("stack") === !1) {
            ...
            ((U = Math.min(U, e.pdfMaxPagesPerSlide)),
              ((U === 1 && e.center) || A.classList.contains("center")) &&
                (W = Math.max((r - fe) / 2, 0)));
            ...
            if (
              ...
              A.slideBackgroundElement &&
                R.insertBefore(A.slideBackgroundElement, A),
              e.showNotes)
            ) {
            ...
            if (t) {
              ...
              (D.classList.add("slide-number"),
                D.classList.add("slide-number-pdf"),
                (D.innerHTML = l++),
                R.appendChild(D));
            }
            if (e.pdfSeparateFragments) {
              const D = this.Reveal.fragments.sort(
  ...
  class hi {
    ...
    update(e, i, t = this.Reveal.getCurrentSlide()) {
      ...
      if (
        ...
        ((i = i || this.sort(t.querySelectorAll(".fragment"))), i.length)
      ) {
        let a = 0;
        if (typeof e != "number") {
        ...
        (Array.from(i).forEach((r, o) => {
          if (
            (r.hasAttribute("data-fragment-index") &&
              (o = parseInt(r.getAttribute("data-fragment-index"), 10)),
            (a = Math.max(a, o)),
            o <= e)
          ) {
    ...
    goto(e, i = 0) {
      ...
      if (t && this.Reveal.getConfig().fragments) {
        ...
        if (s.length) {
          if (typeof e != "number") {
            let r = this.sort(
              t.querySelectorAll(".fragment:not(.disabled).visible"),
            ).pop();
            r
              ? (e = parseInt(r.getAttribute("data-fragment-index") || 0, 10))
              : (e = -1);
          }
          e += i;
    ...
    deactivate() {
      if (this.Reveal.getConfig().overview) {
        ((this.active = !1),
          ...
          b(this.Reveal.getBackgroundsElement(), ".slide-background").forEach(
            (i) => {
              X(i, "");
            },
          ),
    ...
    onSlideClicked(e) {
      if (this.isActive()) {
        ...
        if (
          ...
          (this.deactivate(), i.nodeName.match(/section/gi))
        ) {
  ...
  class fi {
    ...
    onDocumentKeyDown(e) {
      let i = this.Reveal.getConfig();
      if (
        (typeof i.keyboardCondition == "function" &&
          i.keyboardCondition(e) === !1) ||
      ...
      if (
        ...
        (this.Reveal.isPaused() && g.indexOf(t) === -1)
      )
        return !1;
      let p =
          i.navigationMode === "linear" ||
  ...
  class gi {
      ...
      if (!/^[0-9]*$/.test(s[0]) && t.length) {
        ...
        try {
          ...
          a = (
            ...
            document.querySelector(`[data-id="${o}"]`)
        ...
        return (
          a.fragmentInURL &&
            ((u = parseInt(s[2], 10)), isNaN(u) && (u = void 0)),
          { h: o, v: c, f: u }
        );
      }
      return null;
    ...
    readURL() {
      ...
      i
        ? (i.h !== e.h || i.v !== e.v || i.f !== void 0) &&
          this.Reveal.slide(i.h, i.v, i.f)
  ...
  class pi {
    ...
    configure(e, i) {
      ...
      ((this.element.style.display =
        e.controls && (!t || this.Reveal.isSpeakerNotes()) ? "block" : "none"),
      ...
      (tt && (e = ["touchend"]),
        e.forEach((i) => {
          (this.controlsLeft.forEach((t) =>
            t.addEventListener(i, this.onNavigateLeftClicked, !1),
          ),
            this.controlsRight.forEach((t) =>
              t.addEventListener(i, this.onNavigateRightClicked, !1),
            ),
            this.controlsUp.forEach((t) =>
              t.addEventListener(i, this.onNavigateUpClicked, !1),
            ),
            this.controlsDown.forEach((t) =>
              t.addEventListener(i, this.onNavigateDownClicked, !1),
            ),
            this.controlsPrev.forEach((t) =>
              t.addEventListener(i, this.onNavigatePrevClicked, !1),
            ),
            this.controlsNext.forEach((t) =>
              t.addEventListener(i, this.onNavigateNextClicked, !1),
            ),
            this.controlsFullscreen.forEach((t) =>
              t.addEventListener(i, this.onEnterFullscreen, !1),
            ));
        }));
    }
    unbind() {
      ["touchstart", "touchend", "click"].forEach((e) => {
        (this.controlsLeft.forEach((i) =>
          i.removeEventListener(e, this.onNavigateLeftClicked, !1),
        ),
          this.controlsRight.forEach((i) =>
            i.removeEventListener(e, this.onNavigateRightClicked, !1),
          ),
          this.controlsUp.forEach((i) =>
            i.removeEventListener(e, this.onNavigateUpClicked, !1),
          ),
          this.controlsDown.forEach((i) =>
            i.removeEventListener(e, this.onNavigateDownClicked, !1),
          ),
          this.controlsPrev.forEach((i) =>
            i.removeEventListener(e, this.onNavigatePrevClicked, !1),
          ),
          this.controlsNext.forEach((i) =>
            i.removeEventListener(e, this.onNavigateNextClicked, !1),
          ),
          this.controlsFullscreen.forEach((i) =>
            i.removeEventListener(e, this.onEnterFullscreen, !1),
          ));
      });
    }
    update() {
      ...
      if (i) {
        ...
        const s = this.Reveal.isVerticalSlide(i),
          a =
            s &&
            i.parentElement &&
            i.parentElement.querySelectorAll(":scope > section").length > 1;
        s && a
          ? (t.prev &&
    ...
    registerPlugin(e) {
      ...
      typeof i != "string"
        ...
        : this.registeredPlugins[i] === void 0
          ? ((this.registeredPlugins[i] = e),
            this.state === "loaded" &&
              typeof e.init == "function" &&
              e.init(this.Reveal))
          : console.warn(
              'reveal.js: "' + i + '" plugin has already been registered',
            );
    }
    hasPlugin(e) {
    ...
    showHelp() {
      if (this.Reveal.getConfig().help) {
        ...
        for (let s in t)
          t[s].key &&
            t[s].description &&
            (e += `<tr><td>${t[s].key}</td><td>${t[s].description}</td></tr>`);
        ((e += "</table>"),
...
`)
      ...
      (this.context.save(),
        ...
        this.playing
          ? ((this.context.fillStyle = "#fff"),
            ...
            this.context.fillRect(a / 2 + 4, 0, a / 2 - 4, a))
          : (this.context.beginPath(),
  ...
  function ot(h, e) {
    arguments.length < 2 &&
      ((e = arguments[0]), (h = document.querySelector(".reveal")));
    const i = {};
    let t = {},
      s = !1,
      a = !1,
    ...
    function ki(n) {
      ...
      if (
        ((s = !0),
        (l.wrapper = h),
        (l.slides = h.querySelector(".slides")),
        !l.slides)
      )
      ...
      s !== !1 &&
        ...
        setTimeout(() => {
          (l.slides.classList.remove("no-transition"),
            ...
            _({
              type: "ready",
              data: { indexh: r, indexv: o, currentSlide: u },
            }));
        }, 1));
    }
    function Li() {
    ...
    function Ii() {
      setInterval(() => {
        ((!k.isActive() && l.wrapper.scrollTop !== 0) ||
          l.wrapper.scrollLeft !== 0) &&
          ((l.wrapper.scrollTop = 0), (l.wrapper.scrollLeft = 0));
      }, 1e3);
    }
    function Mi() {
      (document.addEventListener("fullscreenchange", Ne),
        document.addEventListener("webkitfullscreenchange", Ne));
    }
    function Ni() {
    ...
    function ht(n) {
      ...
      (l.wrapper.classList.remove(d.transition),
        ...
        v > 1 &&
          ...
          ((q = new Ai(l.wrapper, () =>
            Math.min(Math.max((Date.now() - fe) / N, 0), 1),
          )),
          q.on("click", Yi),
          (U = !1)),
    ...
    function ut() {
      (window.addEventListener("resize", zt, !1),
        ...
        t.focusBodyOnPageVisibilityChange &&
          document.addEventListener("visibilitychange", Ot, !1));
    }
    function ke() {
      (ze.unbind(),
        ge.unbind(),
    ...
    function Ue(n) {
      (typeof n.layout == "string" && (w.layout = n.layout),
        ...
        w.layout
          ? X(l.slides, w.layout + " " + w.overview)
          : X(l.slides, w.overview));
    }
            ...
            B.style.display !== "none" &&
              (t.center || B.classList.contains("center")
                ? B.classList.contains("stack")
                  ? (B.style.top = 0)
                  : (B.style.top =
                      Math.max((v.height - B.scrollHeight) / 2, 0) + "px")
                : (B.style.top = ""));
          }
          m !== p &&
            _({ type: "resize", data: { oldScale: m, scale: p, size: v } });
        }
        (Hi(),
    ...
    function Hi() {
      if (
        ...
        !t.disableLayout &&
        !O.isActive() &&
        typeof t.scrollActivationWidth == "number" &&
        t.view !== "scroll"
      ) {
        const n = Ce();
        n.presentationWidth > 0 &&
        n.presentationWidth <= t.scrollActivationWidth
    ...
    function Ce(n, d) {
      ...
      return (
        ...
        typeof E.width == "string" &&
          /%$/.test(E.width) &&
          (E.width = (parseInt(E.width, 10) / 100) * E.presentationWidth),
        typeof E.height == "string" &&
          /%$/.test(E.height) &&
          (E.height = (parseInt(E.height, 10) / 100) * E.presentationHeight),
        E
      );
    }
    function yt(n, d) {
    ...
    function qe() {
      return u
        ? !(u.nextElementSibling || (we(u) && u.parentNode.nextElementSibling))
        : !1;
    }
    function St() {
      if (t.pause) {
    ...
    function Q(n, d, v, m) {
      ...
      (d === void 0 && !f.isActive() && (d = bt(P[n])),
        c &&
          c.parentNode &&
          c.parentNode.classList.contains("stack") &&
          yt(c.parentNode, o));
      const x = y.concat();
      y.length = 0;
      let B = r || 0,
      ...
      (Z &&
        ...
        ((A = "running"),
        (re = We(c, u, B, pe)),
        re && l.slides.classList.add("disable-slide-transitions")),
        Ke(),
        ye(),
        f.isActive() && f.update(),
    ...
    function Oi(n, d, v) {
      ...
      ((c = u),
        ...
        E &&
          (R.afterSlideChanged(),
          c &&
            (R.stopEmbeddedContent(c),
            R.stopEmbeddedContent(c.slideBackgroundElement)),
    ...
    function Rt() {
      (ke(),
        ...
        t.autoPlayMedia === !1
          ? R.stopEmbeddedContent(u, { unloadIframes: !1 })
          : R.startEmbeddedContent(u),
        f.isActive() && f.layout(),
        _({ type: "sync" }));
    }
    ...
    function Ke() {
      ...
      if (d && typeof r != "undefined") {
        ...
        (he && (P = E ? 6 : t.mobileViewDistance),
          O.isActive() && (P = Number.MAX_VALUE));
        for (let x = 0; x < d; x++) {
          let B = n[x],
            pe = b(B, "section"),
            Z = pe.length;
          if (
            ((v = Math.abs((r || 0) - x) || 0),
            t.loop && (v = Math.abs(((r || 0) - x) % (d - P)) || 0),
            v < P ? R.load(B) : R.unload(B),
            Z)
          ) {
            let G = E ? 0 : bt(B);
            for (let M = 0; M < Z; M++) {
              let re = pe[M];
              ((m = Math.abs(x === (r || 0) ? (o || 0) - M : M - G)),
                v + m < P ? R.load(re) : R.unload(re));
            }
          }
        }
        (It()
    ...
    function ae({ includeFragments: n = !1 } = {}) {
      ...
      if (
        ...
        ((m.left = m.left || E.prev),
          (m.up = m.up || E.prev),
          (m.down = m.down || E.next),
          (m.right = m.right || E.next));
      }
      if (t.rtl) {
        let E = m.left;
    ...
    function Pt(n = u) {
      ...
      e: for (let m = 0; m < d.length; m++) {
        ...
        if (E === n) break;
        E.classList.contains("stack") === !1 &&
          E.dataset.visibility !== "uncounted" &&
          v++;
      }
      return v;
    }
    ...
    function Lt(n) {
      ...
      if (n)
        if (k.isActive())
          ((d = parseInt(n.getAttribute("data-index-h"), 10)),
            n.getAttribute("data-index-v") &&
              (v = parseInt(n.getAttribute("data-index-v"), 10)));
        else {
          let E = we(n),
            P = E ? n.parentNode : n,
            x = de();
          ((d = Math.max(x.indexOf(P), 0)),
            (v = void 0),
            E && (v = Math.max(b(n.parentNode, "section").indexOf(n), 0)));
        }
    ...
    function _e() {
      return b(
        l.wrapper,
        ue + ':not(.stack):not([data-visibility="uncounted"])',
      );
    }
    function de() {
    ...
    function $i(n) {
      if (typeof n == "object") {
        ...
        let d = ne(n.paused),
          v = ne(n.overview);
        (typeof d == "boolean" && d !== Se() && At(d),
          typeof v == "boolean" && v !== f.isActive() && f.toggle(v),
          F.setState(n));
      }
    }
    function be() {
      if ((Le(), u && t.autoSlide !== !1)) {
        ...
        (d
          ...
          N &&
            ...
            ((W = setTimeout(() => {
              (typeof t.autoSlideMethod == "function"
                ? t.autoSlideMethod()
                : Ye(),
                be());
            }, N)),
    ...
    function Ie({ skipFragments: n = !1 } = {}) {
      ...
      t.rtl
        ? (f.isActive() || n || C.next() === !1) &&
          ae().left &&
          Q(r + 1, t.navigationMode === "grid" ? o : void 0)
        : (f.isActive() || n || C.prev() === !1) &&
          ae().left &&
          Q(r - 1, t.navigationMode === "grid" ? o : void 0);
    }
    ...
    function Ht({ skipFragments: n = !1 } = {}) {
      ...
      if (n || C.prev() === !1)
        if (ae().up) $e({ skipFragments: n });
          ...
          if (
            (t.rtl
              ? (d = b(l.wrapper, se + ".future").pop())
              : (d = b(l.wrapper, se + ".past").pop()),
