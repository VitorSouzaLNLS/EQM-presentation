...
\begin{tikzpicture}[>=latex]
    ...
    \draw[line width=0.7pt, red] (-3.4, 1.0) -- (0, 0.01) -- (2, -0.6);% node[right, yshift={-0.25em}] {\small{beam}};
    \draw[line width=0.7pt, red] (-3.4, 1.4) -- (0, -0.01) -- (2, -0.8);% node[right, yshift={-0.25em}] {\small{beam}};
    ...
    \draw[thick, gray, <->] (\sbpm-0.3, \dybba) -- (\sbpm-0.3, 0) node[midway, left] {\small $x_\text{\tiny{offset,real}}$};
