...
\begin{tikzpicture}[>=latex]
    ...
    \node[above] at ($(O)+(0.7,\qalt/2)$) {Quad};
    ...
    \draw[line width=0.7pt, red] (-3.4, 1.0) -- (0, 0.00) -- (2, -0.5);% node[right, yshift={-0.25em}] {\small{beam}};
    \draw[line width=0.7pt, red] (-3.4, 1.4) -- (0, 0.00) -- (2, -0.9);% node[right, yshift={-0.25em}] {\small{beam}};

    % régua
    \bpmrule{\sbpm}{4}{41}{black}
    \pgfmathsetmacro{\dybba}{-1.17}
    \pgfmathsetmacro{\xbpm}{0.0}
    \node[above, black] at (\sbpm, 2) {\small{BPM}};
    \draw[thick, gray, <->] (\sbpm-0.7, \dybba) -- (\sbpm-0.7, 0) node[midway, left] {\small $x_\text{\tiny{offset,BBA}} = x_\text{\tiny{offset,real}}$};
